...
Definition ___compcert_i64_dtos : ident := 70%positive.
Definition ___compcert_i64_dtou : ident := 71%positive.
Definition ___compcert_i64_sar : ident := 82%positive.
Definition ___compcert_i64_sdiv : ident := 76%positive.
Definition ___compcert_i64_shl : ident := 80%positive.
Definition ___compcert_i64_shr : ident := 81%positive.
Definition ___compcert_i64_smod : ident := 78%positive.
Definition ___compcert_i64_smulh : ident := 83%positive.
Definition ___compcert_i64_stod : ident := 72%positive.
Definition ___compcert_i64_stof : ident := 74%positive.
Definition ___compcert_i64_udiv : ident := 77%positive.
Definition ___compcert_i64_umod : ident := 79%positive.
Definition ___compcert_i64_umulh : ident := 84%positive.
Definition ___compcert_i64_utod : ident := 73%positive.
Definition ___compcert_i64_utof : ident := 75%positive.
Definition ___compcert_va_composite : ident := 69%positive.
Definition ___compcert_va_float64 : ident := 68%positive.
Definition ___compcert_va_int32 : ident := 66%positive.
Definition ___compcert_va_int64 : ident := 67%positive.
...
Definition _new_cell : ident := 56%positive.
Definition _new_table : ident := 55%positive.
Definition _next : ident := 3%positive.
Definition _p : ident := 53%positive.
Definition _r : ident := 62%positive.
Definition _r0 : ident := 61%positive.
Definition _s : ident := 48%positive.
Definition _strcmp : ident := 47%positive.
Definition _strcpy : ident := 46%positive.
Definition _strlen : ident := 45%positive.
Definition _table : ident := 57%positive.
